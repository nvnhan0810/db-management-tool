<template>
  <div id="home">
    <el-container>
      ...
      <!-- Main Content -->
      <el-main>
        <template v-if="!connectionStore.activeConnection">
          <ConnectionForm />
        </template>
        <template v-else>
...
watch(() => connectionStore.activeConnection, (newVal: DatabaseConnection | null | undefined, oldVal: DatabaseConnection | null | undefined) => {
...
.el-aside {
  ...
  margin-top: 2rem;
  /* Add margin to avoid overlapping with title bar */
}
